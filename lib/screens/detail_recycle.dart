...
class DetailRecycleGoGreen extends StatelessWidget {
  const DetailRecycleGoGreen({super.key});
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              'Pilih kategori sampah yang akan di daur ulang sendiri tanpa di angkut tukang sampah nantinya, bisa pilih salah satu atau keduanya.',
              style: GoogleFonts.nunito(
